...
WATCHLIST = [
    ...
    # Fertilizantes
    {
        ...
        "benchmark_min": 0.08,
        "benchmark_max": 0.09,
        "descripcion": "Distribuidora de fertilizantes especiales en Chile. Filial de SQM. Reclasificada de DGI a Vaca Lechera (2026): BPA decreciente 5 anos seguidos (-14%/ano), no corresponde la exigencia de una empresa en crecimiento.",
    },
    # Holding
    {
        "ticker": "QUINENCO",
...
async def analizar_ticker(ticker_config, bcs_client):
    ...
    resultado = {
        ...
        "benchmark_min_pct": round(ticker_config["benchmark_min"] * 100, 2),
        "benchmark_max_pct": round(ticker_config["benchmark_max"] * 100, 2),
